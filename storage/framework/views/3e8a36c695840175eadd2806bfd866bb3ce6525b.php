...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo e(URL::asset('css/mycss.css')); ?>">
    <!-- Styles -->
        ...
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="<?php echo e(url('/')); ?>">
                    <span class="color">Find Kost</span>
                </a>
            </div>
                    ...
                    <?php else: ?>
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu" role="menu">
                                ...
                                <li><a href="<?php echo e(url('/wishlist')); ?>"><i class="fa fa-btn fa-briefcase"></i>Wish List</a></li>
                                <li><a href="<?php echo e(url('/logout')); ?>"><i class="fa fa-btn fa-sign-out"></i>Logout</a></li>
                            </ul>
                        </li>
                    <?php endif; ?>
