        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form enctype="multipart/form-data" class="form-horizontal" role="form" method="post" action="<?php echo e(url('/insertkost')); ?>">
                        ...
                        <div class="form-group<?php echo e($errors->has('address') ? ' has-error' : ''); ?>">
                            ...
                            <div class="col-md-6">
                                <input id="address" type="text" class="form-control" name="address" value="<?php echo e(old('email')); ?>">
                        ...
                        <div class="form-group<?php echo e($errors->has('price') ? ' has-error' : ''); ?>">
                            ...
                            <div class="col-md-6">
                                <input id="rating" type="text" class="form-control" name="price">
